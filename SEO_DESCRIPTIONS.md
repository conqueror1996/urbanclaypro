...
# UrbanClay Premium SEO Product Descriptions

Use these verified, 300+ word descriptions to replace the short text in your Sanity CMS. 
These are optimized for keywords like "Exposed Brick", "Terracotta Tiles", "Jaali", and "Sustainability".

---

## 1. Exposed Wirecut Bricks (General Category)
**Keywords:** Exposed brick, wirecut, façade, sustainability, thermal insulation.
...
## 2. Terracotta Brick Cladding Tiles
**Keywords:** Brick tiles, cladding, veneer, renovation, interior design.
...
## 3. Terracotta Jaali Panels
**Keywords:** Jaali, perforated blocks, ventilation, bioclimatic design, screen.
...
## 4. Heritage Floor Tiles
**Keywords:** Floor tiles, terracotta flooring, courtyard, rustic, eco-friendly.
