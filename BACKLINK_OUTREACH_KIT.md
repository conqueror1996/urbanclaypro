# Urban Clay Backlink Outreach Kit

Use these templates to easily request backlinks. Copy, paste, and fill in the brackets!

## 1. Email to Architects/Designers (High Success Rate)
...
## 2. Directory "About Us" Description (Standardized)
Use this specific text when registering on generic sites (JustDial, IndiaMART, YellowPages) to ensure keyword consistency.
...
## 3. Submission Blurb for Architecture Blogs (ArchDaily/Dezeen)
When submitting a project, include this in the "Materials/Suppliers" section.

> **Facade/Cladding Material:** Urban Clay (India)
> **Product Used:** [e.g. Exposed Wirecut Bricks in Terracotta Red]
> **Manufacturer Website:** https://urbanclay.in
> **Material Note:** The project utilizes high-thermal mass custom terracotta units from Urban Clay, selected for their sustainable properties and ability to withstand the local [City Name] climate while aging gracefully.
