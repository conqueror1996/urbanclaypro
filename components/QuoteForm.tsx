                            ...
                            {currentStep === 3 && (
                                ...
                                >
                                    ...
                                    <div className="flex gap-3 mt-4">
                                        ...
                                        <button
                                            type="submit"
                                            className="flex-[2] py-4 rounded-full bg-[var(--terracotta)] text-white font-medium hover:bg-[#a85638] transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                                        >
