        ...
        <div className="h-full flex flex-col">
            <div className="flex items-center justify-between mb-8 border-b border-gray-100 pb-4">
                <div>
                    ...
                    <h3 className="font-serif text-2xl text-[#2A1E16]">Coverage Calculator</h3>
                </div>
                ...
                <AnimatePresence>
                    {boxes !== null && (
                        ...
                        >
                            ...
                            <p className="text-white/60 text-xs font-bold uppercase tracking-wider mb-1">Recommended Order</p>
                            <div className="flex items-baseline gap-2 mb-2">
                                <span className="text-5xl font-mono font-bold text-[var(--terracotta)]">{boxes}</span>
                                <span className="text-lg font-serif">Boxes</span>
                            </div>
                            <p className="text-[10px] text-white/40">Evaluation based on standard wastage. Consult with tiler for precision.</p>
                        </motion.div>
                    )}
                </AnimatePresence>
