...
export default function ProjectAtlas({ projects = [] }: ProjectAtlasProps) {
    return (
        <section className="py-10 md:py-16 bg-[#2A1E16] text-white overflow-hidden relative">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
                    ...
                    <div>
                        ...
                        <h2 className="text-3xl md:text-5xl font-serif mb-3 md:mb-6 leading-tight animate-fade-in-up delay-100">
                            Building India,<br />
                            <span className="text-white/50">One Brick at a Time.</span>
                        </h2>
                        <p className="text-white/60 text-base md:text-lg max-w-md mb-4 md:mb-8 leading-relaxed animate-fade-in-up delay-200">
                        ...
                        <div className="grid grid-cols-2 gap-6 md:gap-8 mb-4 lg:mb-0 animate-fade-in-up delay-300">
                            <div>
