            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center px-4" style={{ perspective: 1000 }}>
                    ...
                    <motion.div
                        ...
                        className="relative bg-[#f5f0eb] rounded-xl md:rounded-3xl p-4 md:p-8 max-w-lg w-full shadow-2xl overflow-hidden max-h-[92vh] overflow-y-auto overscroll-contain scrollbar-hide border border-white/50"
                        data-lenis-prevent
                    >
                        {/* Noise Overlay */}
                        <div
                            ...
                            {!isSubmitted ? (
                                <>
                                    <div className="text-center mb-5 md:mb-8">
                                        <span className="text-[var(--terracotta)] font-bold tracking-widest uppercase text-[10px] mb-1 md:mb-2 block">Premium Material Selection</span>
                                        <h3 className="text-xl md:text-3xl font-serif font-medium text-[#2A1E16]">Order Sample Box</h3>
                                    </div>
