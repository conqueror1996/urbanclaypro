                        ...
                        projects.map((project: any) => (
                            ...
                            >
                                ...
                                <div className="overflow-hidden flex-1">
                                    ...
                                    <p className="text-[10px] text-gray-600 mt-1 uppercase tracking-wider flex items-center gap-2">
                ...
                <AnimatePresence mode="wait">
                    {viewMode === 'list' && !selectedProject && (
                        ...
                        >
                            ...
                            <p className="text-gray-600 mt-2">Manage project details, location, and gallery images.</p>
                        </motion.div>
                    )}
        ...
        >
            ...
            <div className="px-8 py-6 border-b border-gray-100 flex justify-between items-start bg-gray-50/30">
                ...
                <div>
                    ...
                    <div className="flex gap-4 mt-2 text-xs font-bold uppercase tracking-wider text-gray-600 items-center">
                ...
                <div>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            ...
                            <div className="aspect-square border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center text-gray-600 hover:border-[var(--terracotta)] hover:text-[var(--terracotta)] hover:bg-white transition-all relative cursor-pointer group bg-white">
