...
export const metadata: Metadata = {
    title: 'Buy Terracotta Tiles in Bangalore | Free Samples & Delivery',
    description: 'Premium terracotta tiles, clay bricks & jaali panels in Bangalore. Handmade, wirecut & pressed. Free samples. Fast delivery across Bangalore. ISO certified.',
    keywords: [
        'terracotta tiles Bangalore',
        'clay tiles Bangalore',
        'brick tiles Bangalore',
        'jaali panels Bangalore',
            ...
            <main className="pt-32 pb-20">
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
                    <div className="text-center mb-12">
                        <h1 className="text-4xl md:text-6xl font-serif text-[#2A1E16] mb-6">
                            Premium Terracotta Tiles in <span className="text-[var(--terracotta)]">Bangalore</span>
                        </h1>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Buy handcrafted terracotta tiles, clay bricks & jaali panels.
                            Free samples. Fast delivery across Bangalore & Karnataka.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-12">
                        <div className="text-center p-6 bg-[var(--sand)] rounded-2xl">
                            ...
                            <p className="text-sm text-gray-600">Across Bangalore</p>
                        </div>
                        <div className="text-center p-6 bg-[var(--sand)] rounded-2xl">
                            <div className="text-4xl mb-2">📦</div>
                ...
                <section className="bg-gray-50 py-20">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <h2 className="text-3xl font-serif text-center mb-12">Our Products in Bangalore</h2>
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                    <h2 className="text-3xl font-serif text-center mb-12">We Deliver Across Bangalore</h2>

                    <div className="grid md:grid-cols-4 gap-4 text-center">
                        {[
                            'Whitefield', 'Koramangala', 'Indiranagar', 'HSR Layout',
                            'Marathahalli', 'Electronic City', 'Sarjapur', 'Bellandur',
                            'JP Nagar', 'Jayanagar', 'BTM Layout', 'Banashankari',
                            'Yelahanka', 'Hebbal', 'Malleshwaram', 'Rajajinagar'
                        ].map((area) => (
                ...
                <section className="bg-[#2A1E16] text-white py-20">
                    <div className="max-w-4xl mx-auto text-center px-4">
                        ...
                        <p className="text-xl mb-8 text-white/80">
                            Order free samples or speak with our Bangalore team today
                        </p>
