    ...
    return (
        <div className="min-h-screen bg-[var(--sand)]">
            ...
            <main className="pt-20 md:pt-24 pb-12 md:pb-20">
                {/* Header */}
                <div className="bg-[#2A1E16] text-white py-12 md:py-20 px-4 md:px-6">
                    <div className="max-w-7xl mx-auto text-center">
                        <span className="text-[var(--terracotta)] text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase mb-3 md:mb-4 block">Get in Touch</span>
                        <h1 className="font-serif text-4xl md:text-6xl mb-4 md:mb-6">Contact Our Studio</h1>
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 -mt-6 md:-mt-10">
                    <div className="bg-white rounded-2xl md:rounded-3xl shadow-xl overflow-hidden grid lg:grid-cols-2">

                        {/* Contact Info */}
                        <div className="p-6 md:p-16 space-y-8 md:space-y-10 bg-[#FAF7F3]">
                            <div>
                                <h3 className="font-serif text-2xl text-[var(--ink)] mb-1">Mumbai HQ</h3>
                                <p className="text-[#9C8C74] text-xs md:text-sm uppercase tracking-wider font-bold mb-3 md:mb-4">Experience Center</p>
                                <p className="text-[#5d554f] text-sm md:text-base leading-relaxed">
                                    UrbanClay Studio<br />
                            ...
                            <div className="space-y-4">
                                <div>
                                    <p className="text-[#9C8C74] text-[10px] md:text-xs font-bold uppercase tracking-wider mb-1">Phone / WhatsApp</p>
                                ...
                                <div>
                                    <p className="text-[#9C8C74] text-[10px] md:text-xs font-bold uppercase tracking-wider mb-1">Email</p>
                                    <a href="mailto:urbanclay@claytile.in" className="text-base md:text-lg text-[var(--ink)] hover:text-[var(--terracotta)] transition-colors block">
                            ...
                            <div>
                                <h3 className="font-serif text-xl md:text-2xl text-[var(--ink)] mb-3 md:mb-4">Opening Hours</h3>
                                <ul className="space-y-2 text-sm md:text-base text-[#5d554f]">
                        ...
                        <div className="relative min-h-[250px] md:min-h-[400px] w-full bg-[#f4f1ee]">
